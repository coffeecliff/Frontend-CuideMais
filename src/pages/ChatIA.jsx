...
<div className="mb-8">
<h1 className="text-3xl font-bold text-center text-white mb-2">Chat com IA</h1>
</div>
...
<textarea
              ...
              className="bg-white flex-1 resize-none border-white border-2 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-light focus:border-transparent"
...
<button
              ...
              className="text-left p-3 glass-card hover:border-light transition-colors"
